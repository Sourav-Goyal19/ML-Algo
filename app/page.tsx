...
export default function LandingPage() {
  ...
  return (
    <div className="max-w-screen-2xl mx-auto relative text-white">
      <Header />
      <main>
        <section className="px-6 lg:px-14 h-screen xl:h-full xl:py-48 flex flex-col justify-center items-center text-center bg-gradient-to-b from-[#111827] to-[#0b0f19]">
          <motion.h1
        ...
        <section className="px-6 lg:px-14 py-20 bg-gradient-to-b from-[#111827] to-[#0b0f19] text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((point, index) => (
              <motion.div
                ...
                className="bg-[#0b0f19]/5 p-6 rounded-lg shadow-lg border-[#374151] border"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {mlFeatures.map((feature, index) => (
              <motion.div
                ...
                className="bg-[#0b0f19]/30 p-6 rounded-lg shadow-lg border-[#374151] border"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-12">
            {steps.map((step, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.2 }}
                className="bg-[#0b0f19]/30 p-8 rounded-lg shadow-lg border-[#374151] border"
              >
